# Velocity French Podcast

Daily bilingual French/English podcast video at A2 level, generated automatically and uploaded to YouTube.

## Features
- 15-minute conversation between French hosts
...
2. `upload_to_youtube.py` - uploads the video + thumbnail to the Velocity French Podcast YouTube channel
